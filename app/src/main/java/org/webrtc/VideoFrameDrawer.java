...
public class VideoFrameDrawer {
  ...
  private void calculateTransformedRenderSize(
    ...
    Log.i("ppt", "ppt render, in calculateTransformedRenderSize, dstPoints:" + 
		dstPoints[0] + "," + dstPoints[1] + "," + dstPoints[2] + "," + dstPoints[3] + "," + dstPoints[4] + "," + dstPoints[5]);
  ...
  public void drawFrame(VideoFrame frame, RendererCommon.GlDrawer drawer,
    ...
    //Log.i("drawFrame", "ppt, in drawFrame 3, isTextureFrame: " + isTextureFrame);
    if (isTextureFrame) {
      lastI420Frame = null;
      ...
      Log.i("ppt", "ppt, in drawFrame 3, go to drawYuv.\n");
