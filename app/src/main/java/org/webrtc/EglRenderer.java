...
public class EglRenderer implements VideoRenderer.Callbacks, VideoSink {
  ...
  private void renderFrameOnRenderThread() {
	...
	Log.i("renderFrame", "ppt render, in renderFrameOnRenderThread, frame:" + frame.getRotatedWidth() + "," +
            frame.getRotatedHeight() +"," + frameAspectRatio + ", drawnAspectRatio:" + drawnAspectRatio);
