...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
  ...
  public VideoEncoder createEncoder(VideoCodecInfo input) {
    Log.i(TAG, "ppt, in HardwareVideoEncoderFactory createEncoder, go in.");
  ...
  private boolean isSupportedCodec(MediaCodecInfo info, VideoCodecType type) {
    if (!MediaCodecUtils.codecSupportsType(info, type)) {
	  Log.i(TAG, "ppt, in isSupportedCodec, not MediaCodecUtils.codecSupportsType.\n");
      return false;
    }
    ...
    if (MediaCodecUtils.selectColorFormat(
        ...
        == null) {
      Log.i(TAG, "ppt, in isSupportedCodec, not MediaCodecUtils.selectColorFormat null.\n");
      return false;
    }
