...
public class DefaultVideoEncoderFactory implements VideoEncoderFactory {
  ...
  public VideoEncoder createEncoder(VideoCodecInfo info) {
    Log.i(TAG, "ppt, in DefaultVideoEncoderFactory createEncoder, go in.");
  ...
  public VideoCodecInfo[] getSupportedCodecs() {
	...
	Log.i(TAG, "ppt, in DefaultVideoEncoderFactory getSupportedCodecs, go to softwareVideoEncoderFactory.getSupportedCodecs.");
    supportedCodecInfos.addAll(Arrays.asList(softwareVideoEncoderFactory.getSupportedCodecs()));
	Log.i(TAG, "ppt, in DefaultVideoEncoderFactory getSupportedCodecs, go to hardwareVideoEncoderFactory.getSupportedCodecs.");
