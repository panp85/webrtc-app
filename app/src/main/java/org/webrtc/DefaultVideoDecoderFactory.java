...
public class DefaultVideoDecoderFactory implements VideoDecoderFactory {
  ...
  public VideoCodecInfo[] getSupportedCodecs() {
    ...
    Log.i(TAG, "ppt, in DefaultVideoDecoderFactory getSupportedCodecs, go to softwareVideoDecoderFactory.getSupportedCodecs.");
    supportedCodecInfos.addAll(Arrays.asList(softwareVideoDecoderFactory.getSupportedCodecs()));
	Log.i(TAG, "ppt, in DefaultVideoDecoderFactory getSupportedCodecs, go to hardwareVideoDecoderFactory.getSupportedCodecs.");
