...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  public void onConnectedToRoom(final SignalingParameters params) {
    ...
    public void onRemoteDescription(final SessionDescription sdp) {
        final long delta = System.currentTimeMillis() - callStartedTimeMs;
		Exception e = new Exception("ppt, in CallActivity onRemoteDescription");
		e.printStackTrace();
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void onRemoteIceCandidate(final IceCandidate candidate) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
				...
				Log.i(TAG, "ppt, in onRemoteIceCandidate, candidate:" + candidate.sdp);
  ...
  public void onIceCandidate(final IceCandidate candidate) {
    runOnUiThread(new Runnable() {
      ...
      public void run() {
        if (appRtcClient != null) {
		  Log.i(TAG, "ppt, in onIceCandidate, go to appRtcClient.sendLocalIceCandidate, candidate:" + candidate);
