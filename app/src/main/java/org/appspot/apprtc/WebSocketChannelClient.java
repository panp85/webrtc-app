...
public class WebSocketChannelClient {
  ...
  public void register(final String roomID, final String clientID) {
    ...
    Log.i(TAG, "ppt, Registering WebSocket for room " + roomID + ". ClientID: " + clientID);
...
Log.i(TAG, "ppt, in onOpen WebSocketObserver, go to register, roomID:" + roomID + ", ClientID: " + clientID);
