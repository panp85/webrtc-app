...
public class PeerConnectionClient {
  ...
  private void createPeerConnectionFactoryInternal(PeerConnectionFactory.Options options) {
    ...
    Log.i(TAG, "ppt, in createPeerConnectionFactoryInternal, peerConnectionParameters.videoCodecHwAcceleration: " + 
		peerConnectionParameters.videoCodecHwAcceleration + 
  ...
  private void createPeerConnectionInternal() {
    ...
    Log.e(TAG, "ppt, Create peer connection.");
    ...
    Log.e(TAG, "ppt, Peer connection created.");
  }
  ...
  public void createOffer() {
    executor.execute(() -> {
       Log.i(TAG, "ppt, PC Create OFFER, sdpMediaConstraints:" + sdpMediaConstraints);
      if (peerConnection != null && !isError) {
  ...
  public void setRemoteDescription(final SessionDescription sdp) {
    executor.execute(() -> {
      ...
      Log.i(TAG, "ppt, Set remote SDP, sdpDescription: " + sdpDescription);
  ...
  private void drainCandidates() {
    if (queuedRemoteCandidates != null) {
      ...
      for (IceCandidate candidate : queuedRemoteCandidates) {
	  	Log.i(TAG, "ppt, in drainCandidates, go to addIceCandidate, candidate: " + candidate);
        peerConnection.addIceCandidate(candidate);
      }
  ...
  private class PCObserver implements PeerConnection.Observer {
    ...
    public void onIceCandidate(final IceCandidate candidate) {
      Exception e = new Exception("ppt, in PCObserver onIceCandidate");
			e.printStackTrace();
  ...
  private class SDPObserver implements SdpObserver {
    ...
    public void onCreateSuccess(final SessionDescription origSdp) {
      ...
      executor.execute(() -> {
        if (peerConnection != null && !isError) {
          Log.i(TAG, "ppt, Set local SDP from " + sdp.type);
      ...
      executor.execute(() -> {
        ...
        if (isInitiator) {
          ...
          if (peerConnection.getRemoteDescription() == null) {
            ...
            Log.i(TAG, "ppt, Local SDP set succesfully, localSdp:" + localSdp);
            events.onLocalDescription(localSdp);
          } else {
            // We've just set remote description, so drain remote
            // and send local ICE candidates.
            Log.i(TAG, "ppt, Remote SDP set succesfully");
            drainCandidates();
          }
        } else {
