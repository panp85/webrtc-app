...
public class RoomParametersFetcher {
  ...
  private void roomHttpResponseParse(String response) {
    Log.i(TAG, "ppt, Room response: " + response);
    try {
      ...
      for (PeerConnection.IceServer server : iceServers) {
        Log.i(TAG, "ppt, in roomHttpResponseParse IceServer: " + server);
  ...
  private List<PeerConnection.IceServer> requestTurnServers(String url)
    ...
    Log.i(TAG, "ppt, Request TURN from: " + url);
    ...
    Log.d(TAG, "ppt, TURN response: " + response);
      ...
      for (int j = 0; j < turnUrls.length(); j++) {
        ...
        PeerConnection.IceServer turnServer =
            PeerConnection.IceServer.builder(turnUrl)
              ...
              .createIceServer();
Log.i(TAG, "ppt, turnServer: " + turnUrl + " , " + username + " , " + credential);
