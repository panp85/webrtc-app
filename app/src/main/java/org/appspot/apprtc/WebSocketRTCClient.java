...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelEvents {
  ...
  private void signalingParametersReady(final SignalingParameters signalingParameters) {
    ...
    Log.i(TAG, "ppt, Message URL: " + messageUrl);
        Log.i(TAG, "ppt, Leave URL: " + leaveUrl);
...
Log.i(TAG, "ppt, in sendLocalIceCandidate, json:" + json);
        if (initiator) {
...
Exception x = new Exception("ppt, in onWebSocketMessage WebSocketRTCClient");
		x.printStackTrace();
    if (wsClient.getState() != WebSocketConnectionState.REGISTERED) {
      Log.e(TAG, "Got WebSocket message in non registered state.");
      return;
    }
Log.i(TAG, "ppt, in onWebSocketMessage, msg: " +msg);
    try {
